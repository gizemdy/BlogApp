    ...
    <table class="table">
        ...
        <tbody>
            <?php foreach($blogs as $blog): ?>
                ...
                <td>
                    <?php echo $blog['is_active']  ? '<span class="text-success">Aktif</span>' : '<span
                    class="text-danger">Pasif</span>'; ?>
                </td>
                <td>
                    <a href="edit_blog.php?id=<?php echo $blog['id'];?>" class="btn btn-warning btn-sm">Güncelle</a>
                    <a href="delete_blog.php?id=<?php echo $blog['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Blogu silmek istediğinizden emin misiniz?');">Sil</a>
